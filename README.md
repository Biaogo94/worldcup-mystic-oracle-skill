...
```bash
npx skills add https://github.com/Biaogo94/worldcup-mystic-oracle-skill --skill worldcup-mystic-oracle
```
...
- 公开球员和教练生日按公历处理；缺出生时辰时只作三柱/六字结构参考，不推断时柱，不声称完整喜用神或精确大运。
- 八字模块会输出藏干、十神、月令旺衰、盖头截脚，以及流年/流月/比赛日共振，用作球员/教练角色适配过滤。
